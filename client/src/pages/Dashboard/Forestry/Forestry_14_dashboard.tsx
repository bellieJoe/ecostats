...
const formName = FormEnum.FORESTRY_14;
const sector = Sector.FORESTRY;

const Forestry_14_Dashboard = () => {
    ...
    return (
        <div>
            ...
            Existing Forest Land Use Agreement for Tourism Purposes (FLAgT) CY <Select value={year} className="mr-2" onChange={(y) => setYear(y)} options={[...generateYearOptions(2000, new Date().getFullYear())]} />
            </Title>

            <div className={`${data.length == 0 && "hidden"} mx-auto`}>

                <Card>
                    <p className="text-center mb-4">Total Land Area (in hectares) under Existing Forest Land Use Agreement for Tourism Purposes (FLAgT)</p>
...
export default Forestry_14_Dashboard;
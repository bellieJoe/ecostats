...
const formName = FormEnum.FORESTRY_10;
const sector = Sector.FORESTRY;

const Forestry_10_Dashboard = () => {
    ...
    return (
        <div>
            <Title className="text-center" level={5}>
                Forest land Grazing Lease Agreement (FLGLA) CY <Select value={year} className="mr-2" onChange={(y) => setYear(y)} options={[...generateYearOptions(2000, new Date().getFullYear())]} />
            </Title>

            <div className={`${data.length == 0 && "hidden"} mx-auto`}>

                <Card>
                    <p className="text-center mb-4">Total Land Area (in hectares) under Forest Land Grazing Lease Agreement (FLGLA)</p>
...
export default Forestry_10_Dashboard;
...
const formName = FormEnum.FORESTRY_16;
const sector = Sector.FORESTRY;

const Forestry_16_Dashboard = () => {
    ...
    return (
        <div>
            ...
            Industrial Tree Plantation Lease Agreement (ITPLA) CY <Select value={year} className="mr-2" onChange={(y) => setYear(y)} options={[...generateYearOptions(2000, new Date().getFullYear())]} />
            </Title>

            <div className={`${data.length == 0 && "hidden"} mx-auto`}>

                <Card>
                    <p className="text-center mb-4">Total Land Area (in hectares) under Industrial Tree Plantation Lease Agreement (ITPLA)</p>
...
export default Forestry_16_Dashboard;
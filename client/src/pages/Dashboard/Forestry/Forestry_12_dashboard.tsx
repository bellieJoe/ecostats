...
const formName = FormEnum.FORESTRY_12;
const sector = Sector.FORESTRY;

const Forestry_12_Dashboard = () => {
    ...
    return (
        <div>
            ...
            Existing Forest Land Management Agreement (FLMA) CY <Select value={year} className="mr-2" onChange={(y) => setYear(y)} options={[...generateYearOptions(2000, new Date().getFullYear())]} />
            </Title>

            <div className={`${data.length == 0 && "hidden"} mx-auto`}>

                <Card>
                    <p className="text-center mb-4">Land Area (in hectares) under Existing Forest Land Management Agreement (FLMA)</p>
...
export default Forestry_12_Dashboard;
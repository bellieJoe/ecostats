...
const formName = FormEnum.FORESTRY_8;
const sector = Sector.FORESTRY;

const Forestry_8_Dashboard = () => {
    ...
    return (
        <div>
            <Title className="text-center" level={5}>
                Existing Agroforestry Land Management Agreement CY <Select value={year} className="mr-2" onChange={(y) => setYear(y)} options={[...generateYearOptions(2000, new Date().getFullYear())]} />
            </Title>

            <div className={`${data.length == 0 && "hidden"} mx-auto`}>

                <Card>
                    <p className="text-center mb-4">Land Area (in hectares) under Existing Agroforestry Land Management Agreement</p>
...
export default Forestry_8_Dashboard;
...
const formName = FormEnum.FORESTRY_18;
const sector = Sector.FORESTRY;

const Forestry_18_Dashboard = () => {
    ...
    return (
        <div>
            ...
            Socialized Industrial Forest Management Agreement (SIFMA) CY <Select value={year} className="mr-2" onChange={(y) => setYear(y)} options={[...generateYearOptions(2000, new Date().getFullYear())]} />
            </Title>

            <div className={`${data.length == 0 && "hidden"} mx-auto`}>

                <Card>
                    <p className="text-center mb-4">Total Land Area (in hectares) under Socialized Industrial Forest Management Agreement (SIFMA)</p>
...
export default Forestry_18_Dashboard;
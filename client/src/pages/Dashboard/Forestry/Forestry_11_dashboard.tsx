...
const formName = FormEnum.FORESTRY_11;
const sector = Sector.FORESTRY;

const Forestry_11_Dashboard = () => {
    ...
    return (
        <div>
            ...
            Forest Land Grazing Management Agreement (FLGMA) CY <Select value={year} className="mr-2" onChange={(y) => setYear(y)} options={[...generateYearOptions(2000, new Date().getFullYear())]} />
            </Title>

            <div className={`${data.length == 0 && "hidden"} mx-auto`}>

                <Card>
                    <p className="text-center mb-4">Total Land Area (in hectares) under Forest Land Grazing Management Agreement (FLGMA)</p>
...
export default Forestry_11_Dashboard;
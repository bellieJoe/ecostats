...
const formName = FormEnum.FORESTRY_13;
const sector = Sector.FORESTRY;

const Forestry_13_Dashboard = () => {
    ...
    return (
        <div>
            <Title className="text-center" level={5}>
                Forest Land Use Agreement (FLAg) CY <Select value={year} className="mr-2" onChange={(y) => setYear(y)} options={[...generateYearOptions(2000, new Date().getFullYear())]} />
            </Title>

            <div className={`${data.length == 0 && "hidden"} mx-auto`}>

                <Card>
                    <p className="text-center mb-4">Total Land Area (in hectares) under
Existing Forest Land Use Agreement
(FLAg) </p>
...
export default Forestry_13_Dashboard;
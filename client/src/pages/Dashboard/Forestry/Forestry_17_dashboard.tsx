...
const formName = FormEnum.FORESTRY_17;
const sector = Sector.FORESTRY;

const Forestry_17_Dashboard = () => {
    ...
    return (
        <div>
            ...
            Gratuitous Permit for the Special Uses of Forest Lands (GSUP) CY <Select value={year} className="mr-2" onChange={(y) => setYear(y)} options={[...generateYearOptions(2000, new Date().getFullYear())]} />
            </Title>

            <div className={`${data.length == 0 && "hidden"} mx-auto`}>

                <Card>
                    <p className="text-center mb-4">Total Land Area (in hectares) under Gratuitous Permit for the Special Uses of Forest Lands (GSUP)</p>
...
export default Forestry_17_Dashboard;
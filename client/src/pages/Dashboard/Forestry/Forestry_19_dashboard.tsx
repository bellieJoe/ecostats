...
const formName = FormEnum.FORESTRY_19;
const sector = Sector.FORESTRY;

const Forestry_19_Dashboard = () => {
    ...
    return (
        <div>
            ...
            Existing Special Land Use Permit (SLUP) CY <Select value={year} className="mr-2" onChange={(y) => setYear(y)} options={[...generateYearOptions(2000, new Date().getFullYear())]} />
            </Title>

            <div className={`${data.length == 0 && "hidden"} mx-auto`}>

                <Card>
                    <p className="text-center mb-4">Total Land Area (in hectares) under Existing Special Land Use Permit (SLUP)</p>
...
export default Forestry_19_Dashboard;
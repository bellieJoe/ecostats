...
const formName = FormEnum.FORESTRY_15;
const sector = Sector.FORESTRY;

const Forestry_15_Dashboard = () => {
    ...
    return (
        <div>
            ...
            Existing Integrated Forest Management Agreement (IFMA) CY <Select value={year} className="mr-2" onChange={(y) => setYear(y)} options={[...generateYearOptions(2000, new Date().getFullYear())]} />
            </Title>

            <div className={`${data.length == 0 && "hidden"} mx-auto`}>

                <Card>
                    <p className="text-center mb-4">Total Land Area (in hectares) under Existing Integrated Forest Management Agreement (IFMA)</p>
...
export default Forestry_15_Dashboard;
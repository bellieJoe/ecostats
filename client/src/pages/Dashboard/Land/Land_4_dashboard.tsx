...
const formName = FormEnum.LAND_4;
const sector = Sector.LAND;

const Land_4_Dashboard = () => {
    ...
    return (
        <div>
            <Title className="text-center" level={5}>
                Agricultural Free Patent Issued CY <Select value={year} className="mr-2" onChange={(y) => setYear(y)} options={[...generateYearOptions(2000, new Date().getFullYear())]} />
            </Title>
...
export default Land_4_Dashboard;
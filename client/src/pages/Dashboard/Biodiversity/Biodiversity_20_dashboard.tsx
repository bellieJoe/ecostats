...
const formName = FormEnum.BIODIVERSITY_20;
const sector = Sector.BIODIVERSITY;

const Biodiversity_20_Dashboard = () => {
    ...
    return (
        <div>
            <Title className="text-center" level={5}>
                Wildlife Culture Permit CY <Select value={year} className="mr-2" onChange={(y) => setYear(y)} options={[...generateYearOptions(2000, new Date().getFullYear())]} />
            </Title>
...
export default Biodiversity_20_Dashboard;
...
const formName = FormEnum.BIODIVERSITY_5;
const sector = Sector.BIODIVERSITY;

const Biodiversity_5_Dashboard = () => {
        ...
        if(data[0]){
            setChartData(data.map(a => {
                return {
                    ...
                    "Assessed Area (ha)"  : a.assessed_area
                }
            }))
    ...
    return (
        <div>
            ...
            Mangrove Assessment <Select value={year} className="mr-2" onChange={(y) => setYear(y)} options={[...generateYearOptions(2000, new Date().getFullYear())]} />
            </Title>
            ...
            <div className={`${data.length == 0 && "hidden"} mx-auto`}>
                <ResponsiveContainer width="100%" height={400}>
                    ...
                    layout="vertical">
                        ...
                        <XAxis type="number" />
                        <Tooltip />
                        <Bar dataKey="Assessed Area (ha)" fill="green" />
                        <Legend />
                    </BarChart>
                </ResponsiveContainer>
            </div>
...
export default Biodiversity_5_Dashboard;
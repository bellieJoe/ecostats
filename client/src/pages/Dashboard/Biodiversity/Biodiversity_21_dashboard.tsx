...
const formName = FormEnum.BIODIVERSITY_21;
const sector = Sector.BIODIVERSITY;

const Biodiversity_21_Dashboard = () => {
        ...
        if(data[0]){
            setChartData(data.map(a => {
                return {
                    ...
                    "Number of CTO Issued" : a.number_of_cto_issued,
    ...
    return (
        <div>
            <Title className="text-center" level={5}>
                Clearance to Operate (for Zoological Parks and Botanical Gardens) CY <Select value={year} className="mr-2" onChange={(y) => setYear(y)} options={[...generateYearOptions(2000, new Date().getFullYear())]} />
            </Title>
                ...
                <Card>
                    <ResponsiveContainer width="100%" height={400} >
                        ...
                        data={chartData}>
                            ...
                            <Tooltip  />
                            <Bar dataKey="Number of CTO Issued" fill="green" />
                            <Legend  />
                        </BarChart>
                    </ResponsiveContainer>
                </Card>
...
export default Biodiversity_21_Dashboard;
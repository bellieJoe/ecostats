...
const formName = FormEnum.BIODIVERSITY_28;
const sector = Sector.BIODIVERSITY;

const Biodiversity_28_Dashboard = () => {
    ...
    return (
        <div>
            ...
            Wild Fauna Retrieval and Donation CY <Select value={year} className="mr-2" onChange={(y) => setYear(y)} options={[...generateYearOptions(2000, new Date().getFullYear())]} />
            </Title>
...
export default Biodiversity_28_Dashboard;
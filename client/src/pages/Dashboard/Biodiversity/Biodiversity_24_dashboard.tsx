...
const formName = FormEnum.BIODIVERSITY_24;
const sector = Sector.BIODIVERSITY;

const Biodiversity_24_Dashboard = () => {
    ...
    return (
        <div>
            <Title className="text-center" level={5}>
                Endemic Fauna Species by Taxonomic Group CY <Select value={year} className="mr-2" onChange={(y) => setYear(y)} options={[...generateYearOptions(2000, new Date().getFullYear())]} />
            </Title>
...
export default Biodiversity_24_Dashboard;
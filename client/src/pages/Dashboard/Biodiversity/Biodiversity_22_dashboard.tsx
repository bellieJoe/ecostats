...
const formName = FormEnum.BIODIVERSITY_22;
const sector = Sector.BIODIVERSITY;

const Biodiversity_22_Dashboard = () => {
    ...
    return (
        <div>
            <Title className="text-center" level={5}>
                Known Fauna Species by Taxonomic Group CY <Select value={year} className="mr-2" onChange={(y) => setYear(y)} options={[...generateYearOptions(2000, new Date().getFullYear())]} />
            </Title>
...
export default Biodiversity_22_Dashboard;
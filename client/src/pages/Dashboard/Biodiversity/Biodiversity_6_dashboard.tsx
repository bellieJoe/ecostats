...
const formName = FormEnum.BIODIVERSITY_6;
const sector = Sector.BIODIVERSITY;

const Biodiversity_6_Dashboard = () => {
        ...
        if(data[0]){
            setChartData(data.map(a => {
                return {
                    ...
                    "Rehabilitated Area (ha)"  : a.rehabilitated_area
                }
            }))
    ...
    return (
        <div>
            ...
            Mangrove Area Rehabilitated CY <Select value={year} className="mr-2" onChange={(y) => setYear(y)} options={[...generateYearOptions(2000, new Date().getFullYear())]} />
            </Title>
            ...
            <div className={`${data.length == 0 && "hidden"} mx-auto`}>
                <ResponsiveContainer width="100%" height={400}>
                    ...
                    layout="vertical">
                        ...
                        <XAxis type="number" />
                        <Tooltip />
                        <Bar dataKey="Rehabilitated Area (ha)" fill="green" />
                        <Legend />
                    </BarChart>
                </ResponsiveContainer>
            </div>
...
export default Biodiversity_6_Dashboard;
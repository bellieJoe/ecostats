...
const Forestry_10 = () => {
    ...
    const handleSave = (data) => {
        formSaveMany(data, FormEnum.FORESTRY_10, Sector.FORESTRY)
        .then(res => {
    ...
    const items : TabsProps['items'] = [
        ...
        },
        {
            ...
            children: <CustomReport 
                        formName={FormEnum.FORESTRY_10} 
                        sector={Sector.FORESTRY} 
                        fields={forestry_10_gen_form_fields}
                        colDefs={forestry_10_col_defs} />
        },
    ]
    return (
        <>
            { contextHandler }
            <Title level={4} >Forest land Grazing Lease Agreement (FLGLA)</Title>

...
import Forestry_Table_18, { forestry_18_col_defs, forestry_18_gen_form_fields } from "../../../../components/Reports/Forms/Forestry/Forestry_Table_18";
...
const Forestry_18 = () => {
    ...
    const handleSave = (data) => {
        formSaveMany(data, FormEnum.FORESTRY_18, Sector.FORESTRY)
        .then(res => {
    ...
    const items : TabsProps['items'] = [
        ...
        },
        {
            ...
            children: <CustomReport 
                        formName={FormEnum.FORESTRY_18} 
                        sector={Sector.FORESTRY} 
                        fields={forestry_18_gen_form_fields}
                        colDefs={forestry_18_col_defs} />
        },
    ]
    return (
        <>
            { contextHandler }
            <Title level={4} >Socialized Industrial Forest Management Agreement (SIFMA)</Title>

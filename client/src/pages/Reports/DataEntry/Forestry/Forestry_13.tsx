...
import Forestry_Table_13, { forestry_13_col_defs, forestry_13_gen_form_fields } from "../../../../components/Reports/Forms/Forestry/Forestry_Table_13";
...
const Forestry_13 = () => {
    ...
    const handleSave = (data) => {
        formSaveMany(data, FormEnum.FORESTRY_13, Sector.FORESTRY)
        .then(res => {
    ...
    const items : TabsProps['items'] = [
        ...
        },
        {
            ...
            children: <CustomReport 
                        formName={FormEnum.FORESTRY_13} 
                        sector={Sector.FORESTRY} 
                        fields={forestry_13_gen_form_fields}
                        colDefs={forestry_13_col_defs} />
        },
    ]
    return (
        <>
            { contextHandler }
            <Title level={4} >Forest Land Use Agreement (FLAg)</Title>

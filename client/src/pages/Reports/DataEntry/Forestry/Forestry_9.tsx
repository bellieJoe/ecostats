...
import Forestry_Table_7, { forestry_7_col_defs, forestry_7_gen_form_fields } from "../../../../components/Reports/Forms/Forestry/Forestry_Table_7";
import Forestry_Table_9, { forestry_9_col_defs, forestry_9_gen_form_fields } from "../../../../components/Reports/Forms/Forestry/Forestry_Table_9";
...
const Forestry_9 = () => {
    ...
    const handleSave = (data) => {
        formSaveMany(data, FormEnum.FORESTRY_9, Sector.FORESTRY)
        .then(res => {
    ...
    const items : TabsProps['items'] = [
        ...
        },
        {
            ...
            children: <CustomReport 
                        formName={FormEnum.FORESTRY_9} 
                        sector={Sector.FORESTRY} 
                        fields={forestry_9_gen_form_fields}
                        colDefs={forestry_9_col_defs} />
        },
    ]
    return (
        <>
            { contextHandler }
            <Title level={4} >Integrated Social Forestry (ISF)</Title>

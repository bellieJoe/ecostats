...
import Forestry_Table_10, { forestry_10_col_defs, forestry_10_gen_form_fields } from "../../../../components/Reports/Forms/Forestry/Forestry_Table_10";
import Forestry_Table_11, { forestry_11_col_defs, forestry_11_gen_form_fields } from "../../../../components/Reports/Forms/Forestry/Forestry_Table_11";
...
const Forestry_11 = () => {
    ...
    const handleSave = (data) => {
        formSaveMany(data, FormEnum.FORESTRY_11, Sector.FORESTRY)
        .then(res => {
    ...
    const items : TabsProps['items'] = [
        ...
        },
        {
            ...
            children: <CustomReport 
                        formName={FormEnum.FORESTRY_11} 
                        sector={Sector.FORESTRY} 
                        fields={forestry_11_gen_form_fields}
                        colDefs={forestry_11_col_defs} />
        },
    ]
    return (
        <>
            { contextHandler }
            <Title level={4} > Forest Land Grazing Management Agreement (FLGMA)</Title>

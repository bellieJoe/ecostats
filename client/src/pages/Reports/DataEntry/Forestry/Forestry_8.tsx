...
import Forestry_Table_8, { forestry_8_col_defs, forestry_8_gen_form_fields } from "../../../../components/Reports/Forms/Forestry/Forestry_Table_8";
...
const Forestry_8 = () => {
    ...
    const handleSave = (data) => {
        formSaveMany(data, FormEnum.FORESTRY_8, Sector.FORESTRY)
        .then(res => {
    ...
    const items : TabsProps['items'] = [
        ...
        },
        {
            ...
            children: <CustomReport 
                        formName={FormEnum.FORESTRY_8} 
                        sector={Sector.FORESTRY} 
                        fields={forestry_8_gen_form_fields}
                        colDefs={forestry_8_col_defs} />
        },
    ]
    return (
        <>
            { contextHandler }
            <Title level={4} >Existing Agroforestry Land Management Agreement</Title>

...
const Forestry_7 = () => {
    ...
    const handleSave = (data) => {
        formSaveMany(data, FormEnum.FORESTRY_7, Sector.FORESTRY)
        .then(res => {
    ...
    const items : TabsProps['items'] = [
        ...
        },
        {
            ...
            children: <CustomReport 
                        formName={FormEnum.FORESTRY_7} 
                        sector={Sector.FORESTRY} 
                        fields={forestry_7_gen_form_fields}
                        colDefs={forestry_7_col_defs} />
        },
    ]
    return (
        <>
            { contextHandler }
            <Title level={4} >Community Forest Stewardship Agreement</Title>

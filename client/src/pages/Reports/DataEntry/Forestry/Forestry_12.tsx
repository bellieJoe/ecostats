...
import Forestry_Table_12, { forestry_12_col_defs, forestry_12_gen_form_fields } from "../../../../components/Reports/Forms/Forestry/Forestry_Table_12";
...
const Forestry_12 = () => {
    ...
    const handleSave = (data) => {
        formSaveMany(data, FormEnum.FORESTRY_12, Sector.FORESTRY)
        .then(res => {
    ...
    const items : TabsProps['items'] = [
        ...
        },
        {
            ...
            children: <CustomReport 
                        formName={FormEnum.FORESTRY_12} 
                        sector={Sector.FORESTRY} 
                        fields={forestry_12_gen_form_fields}
                        colDefs={forestry_12_col_defs} />
        },
    ]
    return (
        <>
            { contextHandler }
            <Title level={4} >Existing Forest Land Management Agreement (FLMA)</Title>

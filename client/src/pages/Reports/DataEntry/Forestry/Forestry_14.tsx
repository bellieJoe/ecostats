...
import Forestry_Table_14, { forestry_14_col_defs, forestry_14_gen_form_fields } from "../../../../components/Reports/Forms/Forestry/Forestry_Table_14";
const Forestry_14 = () => {
    ...
    const columns : DataMigratorCol[] = [
        ...
        { headerName: 'tourisim_purpose', field: 'tourisim_purpose', type: DataMigratorColTypes.string },
    ...
    const handleSave = (data) => {
        formSaveMany(data, FormEnum.FORESTRY_14, Sector.FORESTRY)
        .then(res => {
    ...
    const items : TabsProps['items'] = [
        ...
        },
        {
            ...
            children: <CustomReport 
                        formName={FormEnum.FORESTRY_14} 
                        sector={Sector.FORESTRY} 
                        fields={forestry_14_gen_form_fields}
                        colDefs={forestry_14_col_defs} />
        },
    ]
    return (
        <>
            { contextHandler }
            <Title level={4} >Existing Forest Land Use Agreement for Tourism Purposes (FLAgT) </Title>

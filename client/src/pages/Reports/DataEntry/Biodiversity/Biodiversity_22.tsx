...
import Biodiversity_Table_22, { biodiversity_22_col_defs, biodiversity_22_gen_form_fields } from "../../../../components/Reports/Forms/Biodiversity/Biodiversity_Table_22";


const Biodiversity_22 = () => {
    ...
    const handleSave = (data) => { 
        console.log(data)
        formSaveMany(data, FormEnum.BIODIVERSITY_22, Sector.BIODIVERSITY)
        .then(res => {
    ...
    const items : TabsProps['items'] = [
        {
            key: '1',
            label: 'Form',
            children: <Biodiversity_Table_22 />,
        },
        {
            key: '2',
            label: 'Migration',
        ...
        },
        {
            ...
            children: <CustomReport 
                        formName={FormEnum.BIODIVERSITY_22} 
                        sector={Sector.BIODIVERSITY} 
                        fields={biodiversity_22_gen_form_fields}
                        colDefs={biodiversity_22_col_defs} />
        },
    ]
    return (
        <>
            { contextHandler }
            <Title level={4} >Known Fauna Species by Taxonomic Group</Title>

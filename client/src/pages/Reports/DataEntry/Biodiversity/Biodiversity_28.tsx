...
import Biodiversity_Table_28, { biodiversity_28_col_defs, biodiversity_28_gen_form_fields } from "../../../../components/Reports/Forms/Biodiversity/Biodiversity_Table_28";


const Biodiversity_28 = () => {
    ...
    const handleSave = (data) => { 
        console.log(data)
        formSaveMany(data, FormEnum.BIODIVERSITY_28, Sector.BIODIVERSITY)
        .then(res => {
    ...
    const items : TabsProps['items'] = [
        {
            key: '1',
            label: 'Form',
            children: <Biodiversity_Table_28 />,
        },
        {
            key: '2',
            label: 'Migration',
        ...
        },
        {
            ...
            children: <CustomReport 
                        formName={FormEnum.BIODIVERSITY_28} 
                        sector={Sector.BIODIVERSITY} 
                        fields={biodiversity_28_gen_form_fields}
                        colDefs={biodiversity_28_col_defs} />
        },
    ]
    return (
        <>
            { contextHandler }
            <Title level={4} >Wild Fauna Retrieval and Donation</Title>

...
import Biodiversity_Table_11, { biodiversity_11_col_defs, biodiversity_11_gen_form_fields } from "../../../../components/Reports/Forms/Biodiversity/Biodiversity_Table_11";


const Biodiversity_11 = () => {
    ...
    const columns : DataMigratorCol[] = [
        ...
        { headerName: 'number_of_cwr_issued_previous', field: 'number_of_cwr_issued_previous', type: DataMigratorColTypes.number },
        { headerName: 'number_of_cwr_issued', field: 'number_of_cwr_issued', type: DataMigratorColTypes.number },
    ...
    const handleSave = (data) => {
        console.log(data)
        formSaveMany(data, FormEnum.BIODIVERSITY_11, Sector.BIODIVERSITY)
        .then(res => {
    ...
    const items : TabsProps['items'] = [
        {
            key: '1',
            label: 'Form',
            children: <Biodiversity_Table_11 />,
        },
        {
            key: '2',
            label: 'Migration',
        ...
        },
        {
            ...
            children: <CustomReport 
                        formName={FormEnum.BIODIVERSITY_11} 
                        sector={Sector.BIODIVERSITY} 
                        fields={biodiversity_11_gen_form_fields}
                        colDefs={biodiversity_11_col_defs} />
        },
    ]
    return (
        <>
            { contextHandler }
            <Title level={4} >Certificate of Wildlife Registration</Title>

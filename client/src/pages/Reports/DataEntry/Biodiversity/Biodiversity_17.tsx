...
import Biodiversity_Table_17, { biodiversity_17_col_defs, biodiversity_17_gen_form_fields } from "../../../../components/Reports/Forms/Biodiversity/Biodiversity_Table_17";


const Biodiversity_17 = () => {
    ...
    const handleSave = (data) => {
        console.log(data)
        formSaveMany(data, FormEnum.BIODIVERSITY_17, Sector.BIODIVERSITY)
        .then(res => {
    ...
    const items : TabsProps['items'] = [
        {
            key: '1',
            label: 'Form',
            children: <Biodiversity_Table_17 />,
        },
        {
            key: '2',
            label: 'Migration',
        ...
        },
        {
            ...
            children: <CustomReport 
                        formName={FormEnum.BIODIVERSITY_17} 
                        sector={Sector.BIODIVERSITY} 
                        fields={biodiversity_17_gen_form_fields}
                        colDefs={biodiversity_17_col_defs} />
        },
    ]
    return (
        <>
            { contextHandler }
            <Title level={4} >Wildlife Special Use Permit</Title>

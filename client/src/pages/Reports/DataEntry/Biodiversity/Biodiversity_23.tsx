...
const Biodiversity_23 = () => {
    ...
    const handleSave = (data) => { 
        console.log(data)
        formSaveMany(data, FormEnum.BIODIVERSITY_23, Sector.BIODIVERSITY)
        .then(res => {
    ...
    const items : TabsProps['items'] = [
        {
            key: '1',
            label: 'Form',
            children: <Biodiversity_Table_23 />,
        },
        {
            key: '2',
            label: 'Migration',
        ...
        },
        {
            ...
            children: <CustomReport 
                        formName={FormEnum.BIODIVERSITY_23} 
                        sector={Sector.BIODIVERSITY} 
                        fields={biodiversity_23_gen_form_fields}
                        colDefs={biodiversity_23_col_defs} />
        },
    ]
    return (
        <>
            { contextHandler }
            <Title level={4} >Known Flora Species by Taxonomic Group</Title>

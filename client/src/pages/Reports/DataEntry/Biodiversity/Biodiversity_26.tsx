...
const Biodiversity_26 = () => {
    ...
    const handleSave = (data) => { 
        console.log(data)
        formSaveMany(data, FormEnum.BIODIVERSITY_26, Sector.BIODIVERSITY)
        .then(res => {
    ...
    const items : TabsProps['items'] = [
        {
            key: '1',
            label: 'Form',
            children: <Biodiversity_Table_26 />,
        },
        {
            key: '2',
            label: 'Migration',
        ...
        },
        {
            ...
            children: <CustomReport 
                        formName={FormEnum.BIODIVERSITY_26} 
                        sector={Sector.BIODIVERSITY} 
                        fields={biodiversity_26_gen_form_fields}
                        colDefs={biodiversity_26_col_defs} />
        },
    ]
    return (
        <>
            { contextHandler }
            <Title level={4} >Wild Flora Confiscation</Title>

...
export const biodiversity_2_gen_form_fields : GenericFormFieldV3[] = [
    ...
    },
    {
        ...
        label : "Province", 
        input : (
            <Input type="text" value="Marinduque" readOnly />
        ),
        type : "input",
...
const Biodiversity_Table_2  = () => {
    ...
    const handleOnRowValueChanged = (d) => {
        ...
        console.log(d)
        formUpdate(d.data, FormEnum.BIODIVERSITY_2, Sector.BIODIVERSITY)
        .then(res => {
    ...
    const handleDelete = (id) => {
        formDelete(id, FormEnum.BIODIVERSITY_2, Sector.BIODIVERSITY)
        .then(res => {
    ...
    const handleSubmit = async (d) => {
        console.log(d)
        try {
            await formCreate(d, FormEnum.BIODIVERSITY_2, Sector.BIODIVERSITY)
    ...
    useEffect(() => {
        console.log(cities)
        setLoading(true)
        formGet(FormEnum.BIODIVERSITY_2, Sector.BIODIVERSITY, limit, page)
        .then(res => {
...
export default Biodiversity_Table_2;
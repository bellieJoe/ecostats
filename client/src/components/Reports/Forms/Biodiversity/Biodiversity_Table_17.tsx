...
export const biodiversity_17_gen_form_fields : GenericFormFieldV3[] = [
    {
        name : "calendar_year",
        label : "Calendar Year", 
        input : (
...
export const biodiversity_17_col_defs = [
    { 
        headerName: "CY", 
        field: "calendar_year", 
        editable : true, 
    ...
    { 
        ...
        cellEditorParams : {
            values : ["Amphibians", "Mammals", "Plants", "Invertebrates", "Birds"]
        }
    },
    { 
        headerName: "Number of Permits Issued", 
        field: "number_of_permits_issued", 
        editable : true, 
        type: "numberColumn",
    },
    { 
...
const Biodiversity_Table_17  = () => {
    ...
    const handleOnRowValueChanged = (d) => {
        formUpdate(d.data, FormEnum.BIODIVERSITY_17, Sector.BIODIVERSITY)
        .then(res => {
    ...
    const handleDelete = (id) => {
        formDelete(id, FormEnum.BIODIVERSITY_17, Sector.BIODIVERSITY)
        .then(res => {
    ...
    const handleSubmit = async (d) => {
        try {
            await formCreate(d, FormEnum.BIODIVERSITY_17, Sector.BIODIVERSITY)
    ...
    useEffect(() => {
        setLoading(true)
        formGet(FormEnum.BIODIVERSITY_17, Sector.BIODIVERSITY, limit, page)
        .then(res => {
    ...
    return (
        <>
            ...
            <GenericFormDrawer
            visible={addRecord} 
            fields={biodiversity_17_gen_form_fields} 
...
export default Biodiversity_Table_17;
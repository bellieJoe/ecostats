...
const Biodiversity_Table_28  = () => {
    ...
    const handleOnRowValueChanged = (d) => {
        formUpdate(d.data, FormEnum.BIODIVERSITY_28, Sector.BIODIVERSITY)
        .then(res => {
    ...
    const handleDelete = (id) => {
        formDelete(id, FormEnum.BIODIVERSITY_28, Sector.BIODIVERSITY)
        .then(res => {
    ...
    const handleSubmit = async (d) => {
        try {
            await formCreate(d, FormEnum.BIODIVERSITY_28, Sector.BIODIVERSITY)
    ...
    useEffect(() => {
        setLoading(true)
        formGet(FormEnum.BIODIVERSITY_28, Sector.BIODIVERSITY, limit, page)
        .then(res => {
...
export default Biodiversity_Table_28;
...
export const biodiversity_23_gen_form_fields : GenericFormFieldV3[] = [
    {
        name : "calendar_year",
        label : "Calendar Year", 
        input : (
...
export const biodiversity_23_col_defs = [
    { 
        headerName: "CY", 
        field: "calendar_year", 
        editable : true, 
    ...
    { 
        ...
        cellEditorParams : {
            values : ["Angiosperms", "Pteridophytes", "Gymnosperms"]
        }
    },
    { 
...
const Biodiversity_Table_23  = () => {
    ...
    const handleOnRowValueChanged = (d) => {
        formUpdate(d.data, FormEnum.BIODIVERSITY_23, Sector.BIODIVERSITY)
        .then(res => {
    ...
    const handleDelete = (id) => {
        formDelete(id, FormEnum.BIODIVERSITY_23, Sector.BIODIVERSITY)
        .then(res => {
    ...
    const handleSubmit = async (d) => {
        try {
            await formCreate(d, FormEnum.BIODIVERSITY_23, Sector.BIODIVERSITY)
    ...
    useEffect(() => {
        setLoading(true)
        formGet(FormEnum.BIODIVERSITY_23, Sector.BIODIVERSITY, limit, page)
        .then(res => {
    ...
    return (
        <>
            ...
            <GenericFormDrawer
            visible={addRecord} 
            fields={biodiversity_23_gen_form_fields} 
...
export default Biodiversity_Table_23;
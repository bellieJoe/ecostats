...
export const biodiversity_11_gen_form_fields : GenericFormFieldV3[] = [
    {
        name : "calendar_year",
        label : "Calendar Year", 
        input : (
    ...
    {
        name : "number_of_cwr_issued_previous",
        label : "Number of CWR Issued (previously issued)", 
        input : (
            <Input type="number" />
        ),
        type : "input"
    ...
    {
        name : "number_of_cwr_issued",
        label : "Number of CWR Issued", 
        input : (
            <Input type="number" />
        ),
        type : "input"
...
export const biodiversity_11_col_defs = [
    { 
        headerName: "CY", 
        field: "calendar_year", 
        editable : true, 
    ...
    { 
        headerName: "Number of CWR Issued (previously issued)", 
        field: "number_of_cwr_issued_previous", 
        editable : true, 
        type: "numberColumn",
    },
    { 
        headerName: "Number of CWR Issued", 
        field: "number_of_cwr_issued", 
        editable : true, 
        type: "numberColumn",
    },
    { 
        headerName: "Revenue Generated(Php)", 
...
const Biodiversity_Table_11  = () => {
    ...
    const handleOnRowValueChanged = (d) => {
        formUpdate(d.data, FormEnum.BIODIVERSITY_11, Sector.BIODIVERSITY)
        .then(res => {
    ...
    const handleDelete = (id) => {
        formDelete(id, FormEnum.BIODIVERSITY_11, Sector.BIODIVERSITY)
        .then(res => {
    ...
    const handleSubmit = async (d) => {
        try {
            await formCreate(d, FormEnum.BIODIVERSITY_11, Sector.BIODIVERSITY)
    ...
    useEffect(() => {
        setLoading(true)
        formGet(FormEnum.BIODIVERSITY_11, Sector.BIODIVERSITY, limit, page)
        .then(res => {
    ...
    return (
        <>
            ...
            <GenericFormDrawer
            visible={addRecord} 
            fields={biodiversity_11_gen_form_fields} 
...
export default Biodiversity_Table_11;
...
export const biodiversity_31_gen_form_fields : GenericFormFieldV3[] = [
    {
        name : "calendar_year",
        label : "Calendar Year", 
        input : (
    ...
    },
    {
        ...
        label : "Name of PA/ Conservation Area", 
        input : (
            <Input type="text" />
        ),
        type : "input"
    ...
    },
    {
        ...
        input : (
            <Select options={[
                { value: 'Other Threatened Species', label: 'Other Threatened Species' },
                { value: 'Endangered', label: 'Endangered' },
                { value: 'Critically Endangered', label: 'Critically Endangered' },
                { value: 'Vulnerable', label: 'Vulnerable' },
                { value: 'Least Concern (rare)', label: 'Least Concern (rare)' }
            ]} />
        ),
        type : "input"
    },
...
export const biodiversity_31_col_defs = [
    {
        headerName : "CY",
        field : "calendar_year",
        type : "numberColumn",
    ...
    { 
        headerName: "Name of PA/ Conservation Area", 
        field: "name_of_conservation_area", 
        editable : true, 
        type : "textColumn"
    },
    { 
    ...
    {
        headerName : "Threatened Species",
        field : "threatened_species",
        editable : true,
        type : "textColumn"
    },
    {
        ...
        cellEditor : "agSelectCellEditor",
        cellEditorParams : {
            values : ['Other Threatened Species', 'Endangered', 'Critically Endangered', 'Vulnerable', 'Least Concern (rare)']
        }
    },
    {
...
const Biodiversity_Table_31  = () => {
    ...
    const handleOnRowValueChanged = (d) => {
        formUpdate(d.data, FormEnum.BIODIVERSITY_31, Sector.BIODIVERSITY)
        .then(res => {
    ...
    const handleDelete = (id) => {
        formDelete(id, FormEnum.BIODIVERSITY_31, Sector.BIODIVERSITY)
        .then(res => {
    ...
    const handleSubmit = async (d) => {
        try {
            await formCreate(d, FormEnum.BIODIVERSITY_31, Sector.BIODIVERSITY)
    ...
    useEffect(() => {
        setLoading(true)
        formGet(FormEnum.BIODIVERSITY_31, Sector.BIODIVERSITY, limit, page)
        .then(res => {
...
export default Biodiversity_Table_31;
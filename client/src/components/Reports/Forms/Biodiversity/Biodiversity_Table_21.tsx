...
export const biodiversity_21_gen_form_fields : GenericFormFieldV3[] = [
    {
        name : "calendar_year",
        label : "Calendar Year", 
        input : (
...
export const biodiversity_21_col_defs = [
    { 
        headerName: "CY", 
        field: "calendar_year", 
        editable : true, 
    ...
    { 
        headerName: "Number of CTO Issued", 
        field: "number_of_cto_issued", 
        editable : true, 
        type: "numberColumn",
    },
    { 
...
const Biodiversity_Table_21  = () => {
    ...
    const handleOnRowValueChanged = (d) => {
        formUpdate(d.data, FormEnum.BIODIVERSITY_21, Sector.BIODIVERSITY)
        .then(res => {
    ...
    const handleDelete = (id) => {
        formDelete(id, FormEnum.BIODIVERSITY_21, Sector.BIODIVERSITY)
        .then(res => {
    ...
    const handleSubmit = async (d) => {
        try {
            await formCreate(d, FormEnum.BIODIVERSITY_21, Sector.BIODIVERSITY)
    ...
    useEffect(() => {
        setLoading(true)
        formGet(FormEnum.BIODIVERSITY_21, Sector.BIODIVERSITY, limit, page)
        .then(res => {
...
export default Biodiversity_Table_21;
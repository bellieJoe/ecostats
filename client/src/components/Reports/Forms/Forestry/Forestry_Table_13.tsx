...
export const forestry_13_gen_form_fields : GenericFormFieldV3[] = [
    {
        name : "calendar_year",
        label : "Calendar Year", 
        input : (
...
export const forestry_13_col_defs  = [
    { 
        headerName: "CY", 
        field: "calendar_year", 
        editable : true, 
...
const Forestry_Table_13  = () => {
    ...
    const handleOnRowValueChanged = (d) => {
        formUpdate(d.data, FormEnum.FORESTRY_13, Sector.FORESTRY)
        .then(res => {
    ...
    const handleDelete = (id) => {
        formDelete(id, FormEnum.FORESTRY_13, Sector.FORESTRY)
        .then(res => {
    ...
    const handleSubmit = async (d) => {
        try {
            await formCreate(d, FormEnum.FORESTRY_13, Sector.FORESTRY)
    ...
    useEffect(() => {
        setLoading(true)
        formGet(FormEnum.FORESTRY_13, Sector.FORESTRY, limit, page)
        .then(res => {
    ...
    return (
        <>
            ...
            <GenericFormDrawer
            visible={addRecord} 
            fields={forestry_13_gen_form_fields} 
...
export default Forestry_Table_13;